...
const gravitational_lensingFactory: SimulationFactory = () => {
  ...
  const engine: SimulationEngine = {
    ...
    render() {
      ...
      ctx.fillText("gravitational-lensing Simulation", W/2, H/2);
    },
    reset() { time = 0; },
    destroy() {},
    getStateDescription() { return "gravitational-lensing simulation placeholder."; },
    resize(w, h) { W = w; H = h; }
  };
  return engine;
};

export default gravitational_lensingFactory;
